package org.jocean.restful.closure;
...
import org.jocean.restful.HeaderableOutputReactor;
import org.jocean.restful.OutputSource;
import org.jocean.restful.PackageRegistrarWithZK;
...
public class BizFlowClosure implements Closure<PDUBean> {
    ...
    @Autowired
    private PackageRegistrarWithZK registrar;
